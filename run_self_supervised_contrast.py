"""
Script to run self supervised learning with contrast learning
...
from pl_modules import UnetSelfSupervisedContrastLearningModule
...
def cli_main(args: Namespace):
    ...
    # model
    # ------------
    model = UnetSelfSupervisedContrastLearningModule(
...
def build_args() -> Namespace:
    ...
    parser.add_argument(
        "--config",
        default="./configs/config_self_supervised_contrast_train.yml",
        type=Path,
